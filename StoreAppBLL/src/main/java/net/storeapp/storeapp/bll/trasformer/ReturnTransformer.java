 ...
 */
@Component
public class ReturnTransformer implements CommonTransformer<ReturnEntity, ReturnBean> {
    ...
    @Override
    public ReturnBean fromEntityToBean(ReturnEntity entity) {
    ...
    @Override
    public ReturnEntity fromBeanToEntity(ReturnBean bean) {

...
import net.storeapp.storeapp.common.StoreBean;
import net.storeapp.storeapp.dal.entity.StoreEntity;
 ...
 */
@Component
public class StoreTransformer implements CommonTransformer<StoreEntity, StoreBean> {
    ...
    @Override
    public StoreBean fromEntityToBean(StoreEntity entity) {
    ...
    @Override
    public StoreEntity fromBeanToEntity(StoreBean bean) {

...
/**
 * BorrowEntity generated by hbm2java
 */
@Entity
@Table(name="borrow"
    ,catalog="storeapp"
)
public class BorrowEntity  implements java.io.Serializable {
    ...
    public BorrowEntity(String name, String details, long price, Date date, Date time) {
       this.name = name;
